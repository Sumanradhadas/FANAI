      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 md:p-12">
          ...
          <div className="prose prose-sm max-w-none dark:prose-invert">
            ...
            <p>
              All purchases are final. Tokens are non-refundable once purchased. Service interruptions do not constitute
              grounds for refunds. Each image generation costs 10 tokens. New users receive 20 free tokens upon registration.
            </p>
